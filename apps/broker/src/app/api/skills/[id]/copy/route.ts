...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  // L4 (security-pass-2026-07-03.md): this route accepted bearer OR cookie auth but was
  // missing the CSRF guard sibling routes enforce on the cookie path (e.g. skills/[id]
  // PATCH/DELETE, artifacts/share) — mitigated by SameSite=Lax, but inconsistent. Same
  // guard, same pattern.
