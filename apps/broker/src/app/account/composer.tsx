...
const s = {
  ...
  scopeNote: { fontSize: 13, color: "#94a3b8", margin: "8px 0 0" } as const,
  muted: { color: "#94a3b8" } as const,
  advanced: { marginTop: 12, border: "1px solid #e2e8f0", borderRadius: 9, padding: "8px 12px", background: "#f8fafc" } as const,
  advancedSummary: { cursor: "pointer", fontSize: 13, fontWeight: 600, color: "#475569" } as const,
  ...
  ghostBtn: { background: "#fff", color: "#475569", border: "1px solid #cbd5e1", borderRadius: 9, padding: "8px 16px", fontWeight: 600, fontSize: 14, cursor: "pointer" } as const,
  ...
  meta: { fontSize: 13, color: "#64748b", margin: "10px 0 0", lineHeight: 1.5 } as const,
  speedUp: { marginTop: 12 } as const,
  speedUpSummary: { cursor: "pointer", fontSize: 13, fontWeight: 600, color: "#0f766e" } as const,
  promptPane: { background: "#f0fdfa", border: "1px solid #99f6e4", borderRadius: 10, padding: "12px 14px", marginTop: 12 } as const,
